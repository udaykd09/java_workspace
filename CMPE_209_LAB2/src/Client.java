		...
		try {
			...
			do {
				...
				if (!(userCheck.equals("Warn"))) {
					...
					BigInteger Kc2 = Yc.xor(Kc2_long);
					...
					String Ks2_str = new String(Ks2_byte);
					BigInteger Ks2 = new BigInteger(Ks2_str);
					//System.out.println(" E(Pass,g^Xs.modp) = " + Ks2_str);
					
					// Ks3 = g^Xs = D(Pass, Ks2)
					BigInteger Ks3 = Kc2_long.xor(Ks2);
					...
					// Choose Na
					BigInteger Na = new BigInteger("1014750000000000");
